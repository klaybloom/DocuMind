...
import com.documind.exception.GlobalExceptionHandler;
...
class ChatControllerHttpTest {
    ...
    static class FakeRagService extends RagService {
        ...
        public void askStream(String question,
                              ...
                              java.util.function.Consumer<List<com.documind.dto.SourceReference>> onSources,
                              java.util.function.Consumer<com.documind.dto.RetrievalDebugInfo> onDebug,
                              Runnable onComplete,
            ...
            onSources.accept(List.of(
                    new com.documind.dto.SourceReference(1, "HR", "test.pdf", null, "HR/test.pdf#1", "摘录文本", 0.85)
            ));
            onComplete.run();
        }
